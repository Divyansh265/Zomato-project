                                    ...
                                    <div className='mt-2 flex flex-col gap-3 w-full'>
                                        ...
                                        <form className='flex flex-col gap-2'>
                                            <div className='w-full flex flex-col gap-2'>
                                                ...
                                                <input type="text" id="email" value={userData.email} onChange={handleChange} placeholder="user@gmail.com"
                                            ...
                                            <div className='w-full flex flex-col gap-2'>
                                                ...
                                                <input type="text" id="fullName" value={userData.fullName} onChange={handleChange} placeholder="John Doe"
                                                    className='w-full border border-gray-400 px-3 py-2 rounded-lg focus:border-zomato-400'
                                                />
                                            </div>
                                            <div className='w-full flex flex-col gap-2'>
                                            ...
                                            <div className='w-full text-center bg-zomato-400 text-white pz-2 rounded-lg py-2 cursor-pointer' onClick={submit}>
                                                Sign Up
                                            </div>
                                        </form>
                                    </div>
