                ...
                <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden '>
                    <div className='w-full h-2/4 overflow-hidden rounded-lg'>
                        <img
                            ...
                            alt='restaurant'
                            className='w-full h-full object-cover object-center rounded-lg transition duration-700 hover:scale-100'
                        />
                    </div>
                    <div className='w-full h-2/4 overflow-hidden rounded-lg'>
                        <img
                ...
                <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden'>
                    ...
                    <div className='w-full h-2/4 relative'>
                        <img
                            ...
                            className='w-full h-full object-cover object-center rounded-lg '
                        />
                        <div className='absolute inset-0 bg-opacity-40 bg-black h-full rounded-lg hover:bg-opacity-70'>
